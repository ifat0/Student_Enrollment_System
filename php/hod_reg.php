            ...
            <div class="container">
                <div class="signup-content">
                    <div class="signup-form">
                        <h3 class="form-title">HOD Registration</h3>
                        <form action="hod_reg.php" method="POST" class="register-form" id="register-form">
                            <div class="form-group">
                                <label for="name"><i class="zmdi zmdi-account material-icons-name"></i></label>
                                <input type="number" name="sid" id="sid" placeholder="Enter Hod ID" />
                            </div>
                            <div class="form-group">
                                <label for="name"><i class="zmdi zmdi-account material-icons-name"></i></label>
                                <input type="text" name="name" id="name" placeholder="Enter Hod's Name" />
                            </div>
                            <div class="form-group">
...
<?php
// }
class HOD_Registration extends Dbh{
    public $hd_Id;
    public $hd_Name;
    public $hd_Phone;
    public $hd_Address;
    ...
    if($rows==null){
        ...
        if($_POST['pass']==$_POST['re_pass']){
            ...
            // if (!empty($_POST['name']) && !empty( $_POST['phone']) && !empty($_POST['address']) && !empty($_POST['email']) && !empty($_POST['pass'])){
                ...
                $database->connect($sql="Insert into hod(hd_Id, hd_Name, hd_Email, hd_Phone, hd_Address, hd_Pass) values('".$_POST['sid']."','".$_POST['name']."','".$_POST['email']."','".$_POST['phone']."','".$_POST['address']."','".$_POST['pass']."')");
